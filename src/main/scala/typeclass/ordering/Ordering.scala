...
object Main extends App {
  ...
  println("""emails.sorted(emailOrdering.reverse) == """ + emails.sorted(emailOrdering.reverse))
  println("""people.sorted(personOrderingByEmail) == """ + people.sorted(personOrderingByEmail))
}
